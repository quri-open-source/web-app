...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './design-lab/components/project-create/project-create.component'
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './design-lab/components/project-preview/project-preview.component'
      ).then((m) => m.ProjectPreviewComponent),
    canActivate: [authenticationGuard],
  },
  {
    ...
    loadComponent: () =>
      import(
        './design-lab/components/project-edit/project-edit.component'
...

  {
    ...
    loadComponent: () =>
      import(
        './public/pages/choose-manufacturer/choose-manufacturer.component'
      ).then((m) => m.ChooseManufacturerComponent),
    canActivate: [authenticationGuard],
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './public/pages/manufacturer-dashboard/manufacturer-dashboard.component'
      ).then((m) => m.ManufacturerDashboardComponent),
    canActivate: [authenticationGuard, roleGuard(['ROLE_MANUFACTURER'])],
  },
  {
    path: 'manufacturer-orders',
    loadComponent: () =>
      import(
        './public/pages/manufacturer-orders/manufacturer-orders-page.component'
      ).then((m) => m.ManufacturerOrdersPageComponent),
    canActivate: [authenticationGuard, roleGuard(['ROLE_MANUFACTURER'])],
  },
  {
    ...
    loadComponent: () =>
      import(
        './orders-fulfillments/components/manufacturer-orders/manufacturer-orders.component'
      ).then((m) => m.ManufacturerOrdersComponent),
    canActivate: [authenticationGuard, roleGuard(['ROLE_MANUFACTURER'])],
  },
];
